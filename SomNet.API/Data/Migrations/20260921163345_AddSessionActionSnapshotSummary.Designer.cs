...
namespace SomNet.API.Data.Migrations
{
    ...
    [Migration("20260921163345_AddSessionActionSnapshotSummary")]
    partial class AddSessionActionSnapshotSummary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SomNet.API.Data.Entities.SessionActionSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DomTarget", "SessionId");

                    b.HasIndex("SessionId", "ActionIndex", "Feed")
                        .IsUnique();

                    b.ToTable("SessionActionSnapshots", (string)null);
                });
