...
**Status:** Phase 1 **partial sign-off** (Layout A-dev); Phases **2–6 complete** (manual); **Phase 7 next** (Pi); IP on hold (V1-D9)  
...
| **Next software phase** | [Phase 7 — Pi](./20-Video-Phase-7-Pi-Production-Checklist.md) (repeat tunnel on Pi; iPhone/LTE polish optional follow-up) |
