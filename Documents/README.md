...
| [Device button clicks](./23-Device-Button-Clicks-Checklist.md) | Developers / installers | Single (future) + double (site ready → Start feed) on D33 — **signed off** (2026-09-13) |
